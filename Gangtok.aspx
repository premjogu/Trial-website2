<%@ Page Title="" Language="C#" MasterPageFile="~/Materpage.master" AutoEventWireup="true" CodeFile="Gangtok.aspx.cs" Inherits="Gangtok" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td class="style31" colspan="5">
                <asp:Panel ID="Panel2" runat="server" Height="549px" Width="1272px">
                    <table class="dx-justification" 
                        style="height: 498px; width: 93%; margin-bottom: 0px;">
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="reviewScore hidden-xs" 
                                    ...
                                    <span class="color_white reviewBoxDesktop" 
                                        ...
                                        style="box-sizing: border-box; padding: 5px; border-radius: 3px; color: white; background-color: rgb(154, 204, 43);"><strong 
