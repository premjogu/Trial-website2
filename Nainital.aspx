<%@ Page Title="" Language="C#" MasterPageFile="~/Materpage.master" AutoEventWireup="true" CodeFile="Nainital.aspx.cs" Inherits="Nainital" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label5" runat="server" style="font-size: 50px; color: #990033;" 
                    Text="Nainital Best Places"></asp:Label>
                <br />
                <br />
            </td>
        </tr>
        <tr>
            <td class="style43">
                <ul>
                    <li style="font-size: x-large">
                        <asp:Label ID="Label30" runat="server" Text="Eco Cave Gardens"></asp:Label>
                    </li>
                    <li>
                        <asp:Label ID="Label31" runat="server" CssClass="style8" Text="Naini Lake"></asp:Label>
                    </li>
                    <li>
                <asp:Label ID="Label48" runat="server" CssClass="style8" 
                    Text="Naina Devi Temple"></asp:Label>
                    </li>
                    <li>
                        <asp:Label ID="Label33" runat="server" CssClass="style8" 
                            Text="Snow View Point"></asp:Label>
                    </li>
                    <li>
                        <asp:Label ID="Label34" runat="server" CssClass="style8" Text="Land's End"></asp:Label>
                    </li>
                    <li>
                        <asp:Label ID="Label35" runat="server" CssClass="style8" 
                            Text="Governor's House"></asp:Label>
                    </li>
                    <li>
                <asp:Label ID="Label49" runat="server" style="font-size: x-large" 
                    Text="Nainital Ropeway"></asp:Label>
                    </li>
                    <li>
                        <asp:Label ID="Label45" runat="server" CssClass="style8" 
                            Text="High Altitude Zoo"></asp:Label>
                    </li>
                </ul>
                <p>
                    &nbsp;</p>
            ...
            <td class="style40">
                <asp:Label ID="Label37" runat="server" style="font-size: x-large" 
                    Text="Eco Cave Gardens"></asp:Label>
                <br />
            ...
            <td class="style41">
                <asp:Label ID="Label38" runat="server" CssClass="style8" Text="Naini Lake"></asp:Label>
                <br />
            ...
            <td class="style42">
                ...
                <asp:Image ID="Image32" runat="server" Height="215px" 
                    ImageUrl="~/1SummerImage/Nainital/download (10).jpg" Width="281px" />
            </td>
            <td class="style30">
                ...
                <asp:Image ID="Image33" runat="server" Height="215px" 
                    ImageUrl="~/1SummerImage/Nainital/download (11).jpg" Width="281px" />
            </td>
        </tr>
        <tr>
            <td class="style43">
            ...
            <td class="style40">
                <asp:Label ID="Label41" runat="server" style="font-size: x-large" 
                    Text="Land's End"></asp:Label>
                <asp:Image ID="Image34" runat="server" Height="215px" 
                    ImageUrl="~/1SummerImage/Nainital/lands-end-nainital1.jpg" Width="281px" />
            </td>
            <td class="style41">
                <asp:Label ID="Label42" runat="server" style="font-size: x-large" 
                    Text="Governor's House"></asp:Label>
                <asp:Image ID="Image35" runat="server" Height="215px" 
                    ImageUrl="~/1SummerImage/Nainital/download (12).jpg" Width="281px" />
            </td>
            <td class="style42">
            ...
            <td class="style14">
                ...
                <asp:Image ID="Image37" runat="server" Height="215px" 
                    ImageUrl="~/1SummerImage/Nainital/High-Altitude-Zoo.jpg" Width="281px" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style31" colspan="5">
                <asp:Panel ID="Panel2" runat="server" Height="473px" Width="1142px">
                    <table class="dx-justification" 
                        ...
                        <tr>
                            <td class="style38" colspan="4">
                                ...
                                <asp:Label ID="Label50" runat="server" 
                                    ...
                                    Text="Best Hotels In Nainital"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="style44">
                                ...
                                <asp:Image ID="Image26" runat="server" Height="196px" 
                                    ImageUrl="~/1SummerImage/Nainital/175307659.jpg" Width="264px" />
                            </td>
                            <td class="style37">
                                <h4 class="hotelName" 
                            ...
                            <td class="style45">
                                <asp:Image ID="Image27" runat="server" Height="181px" 
                                    ImageUrl="~/1SummerImage/Nainital/27306129.jpg" Width="247px" />
                            </td>
                            <td class="style22">
                                <h4 class="hotelName" 
                                    style="box-sizing: border-box; font-family: MontSerratBold, MontSerratRegular, sans-serif; font-weight: bold; line-height: 1.1; color: rgb(51, 51, 51); margin-top: 8px; margin-bottom: 10px; font-size: 1.2em; display: block; margin-left: 0px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                                ...
                                <h4 class="hotelName" 
                                    style="box-sizing: border-box; font-family: MontSerratBold, MontSerratRegular, sans-serif; font-weight: bold; line-height: 1.1; color: rgb(51, 51, 51); margin-top: 8px; margin-bottom: 10px; font-size: 1.2em; display: block; margin-left: 0px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                                    Neemrana&#39;s - Ramgarh Bungalows</h4>
                                <div class="hotelParameters" 
                                    style="box-sizing: border-box; color: rgb(51, 51, 51); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                        ...
                        <tr>
                            <td class="style44">
                                ...
                                <asp:Image ID="Image28" runat="server" Height="181px" 
                                    ImageUrl="~/1SummerImage/Nainital/107939180.jpg" Width="266px" />
                            </td>
                            <td class="style36">
                                <h4 class="hotelName" 
                                    style="box-sizing: border-box; font-family: MontSerratBold, MontSerratRegular, sans-serif; font-weight: bold; line-height: 1.1; color: rgb(51, 51, 51); margin-top: 8px; margin-bottom: 10px; font-size: 1.2em; display: block; margin-left: 0px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                                    Nainital Adventure Park &amp; Resort</h4>
                                <div class="hotelParameters" 
                                    style="box-sizing: border-box; color: rgb(51, 51, 51); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                                    <div style="box-sizing: border-box;">
                                    </div>
                            ...
                            <td class="style45">
                                <asp:Image ID="Image29" runat="server" Height="173px" 
                                    ImageUrl="~/1SummerImage/Nainital/144260692.jpg" Width="251px" />
                            </td>
                            <td>
                                <h4 class="hotelName" 
                                    style="box-sizing: border-box; font-family: MontSerratBold, MontSerratRegular, sans-serif; font-weight: bold; line-height: 1.1; color: rgb(51, 51, 51); margin-top: 8px; margin-bottom: 10px; font-size: 1.2em; display: block; margin-left: 0px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                                    1BHK Valley View Bhowali</h4>
                                <div class="hotelParameters" 
                                    style="box-sizing: border-box; color: rgb(51, 51, 51); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">
                                    <div style="box-sizing: border-box;">
                                    </div>
