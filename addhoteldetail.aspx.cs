...
public partial class addPackageDetail : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile == true)
        {
            ...
            if (contenttype == "image/jpeg")
            {
                ...
                if (filesize <= 41200000)
                {
                    ...
                    Label14.Text = "File Has Been Saved Successfully ";
        ...
        String query = "Insert into Hotel_details(id,Place_Name,Hotel_Name,Address,Room_Available,Room_type,Room_Charges,Facility_Available,Image) values('"+ Label16.Text +"','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + DropDownList1.SelectedItem.Value + "','" + DropDownList2.SelectedItem.Value + "','" + TextBox4.Text + "','" + DropDownList3.SelectedItem.Value + "','" + link + "')";
        ...
        Response.Redirect("ShowhotelDetail.aspx");
