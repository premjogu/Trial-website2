<%@ Page Title="" Language="C#" MasterPageFile="~/Materpage.master" AutoEventWireup="true" CodeFile="monsoon.aspx.cs" Inherits="monsoon" %>
        ...
        <tr>
            <td class="style14">
                <asp:HyperLink ID="HyperLink3" runat="server" Font-Underline="False" 
                    ...
                    NavigateUrl="~/munnar.aspx">Munnar</asp:HyperLink>
                <br />
...
<SettingsTableLayout ColumnCount="7" RowsPerPage="1"></SettingsTableLayout>
                </dx:ASPxImageGallery>
                <br />
            </td>
        </tr>
        <tr>
            <td class="style27">
                ...
                <asp:HyperLink ID="HyperLink4" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/Kodaikanal.aspx">Kodaikanal</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style27">
                <asp:HyperLink ID="HyperLink5" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/lonavla.aspx">Lonavala</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style27">
                <asp:HyperLink ID="HyperLink6" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/Mahabaleshwar.aspx">Mahabaleshwar</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style27">
                <asp:HyperLink ID="HyperLink7" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/Coorg.aspx">Coorg</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style27">
                <asp:HyperLink ID="HyperLink8" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/Panchgani.aspx">Panchgani</asp:HyperLink>
                <br />
