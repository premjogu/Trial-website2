<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="usersummer.aspx.cs" Inherits="usersummer" %>
        ...
        <tr>
            <td class="style14">
                <asp:HyperLink ID="HyperLink3" runat="server" Font-Underline="False" 
                    ...
                    NavigateUrl="~/usermanali.aspx">Manali</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                ...
                <asp:HyperLink ID="HyperLink4" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/usershimla.aspx">Shimla</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink6" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/usernainital.aspx">Nainital</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink7" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/usermoutAbu.aspx">Mount Abu</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink9" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/userharidwarandRishikesh.aspx">Haridwar&nbsp;and Rishikesh</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink10" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/usergangtok.aspx">Gangtok</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style21">
                <asp:HyperLink ID="HyperLink11" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/usercherrapunji.aspx">Cherrapunji</asp:HyperLink>
                <br />
