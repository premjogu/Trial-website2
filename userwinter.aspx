<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="userwinter.aspx.cs" Inherits="userwinter" %>
        ...
        <tr>
            <td class="style14">
                <asp:HyperLink ID="HyperLink3" runat="server" Font-Underline="False" 
                    ...
                    NavigateUrl="~/usergoa.aspx">Goa</asp:HyperLink>
                <br />
            ...
            <td class="style15">
                ...
                <span class="style23" 
                    style="font-family: &quot;Open Sans&quot;, sans-serif; font-size: medium; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">Lying on the west coast, Goa is one of the smallest states in India known for 
        ...
        <tr>
            <td class="style12">
                ...
                <asp:HyperLink ID="HyperLink4" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/UserTawang.aspx">Tawang</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink5" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/userAuli.aspx">Auli</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink6" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/UserAndaman and Nicobar.aspx">Andaman &amp; Nicobar</asp:HyperLink>
                <br />
            ...
            <td class="style18">
                ...
                <span class="style25" 
                    style="font-family: &quot;Open Sans&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">Lagoons of crystal clear water and scenic beaches topped with a little bit of 
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink7" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/UserKonark.aspx">Konark</asp:HyperLink>
                <br />
        ...
        <tr>
            <td class="style12">
                <asp:HyperLink ID="HyperLink8" runat="server" Font-Underline="False" 
                    ...
                    style="font-size: xx-large; font-weight: 700; color: #000000; font-family: 'Yu Gothic UI Light';" 
                    NavigateUrl="~/UserShillong.aspx">Shillong</asp:HyperLink>
                <br />
